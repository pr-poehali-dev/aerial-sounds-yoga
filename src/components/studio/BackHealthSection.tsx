...
const FORMATS = [
  { title: "Семейная тренировка 60 мин", desc: "Занятие для всей семьи под руководством инструктора.", price: "" },
  { title: "Семейная тренировка 90 мин", desc: "Занятие для всей семьи под руководством инструктора.", price: "" },
