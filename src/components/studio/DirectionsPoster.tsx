...
const directions = [
  ...
  { label: "ЛОТОС",        name: "ХАТХА ЙОГА",            sub: "Классическая практика" },
  { label: "БЛОК + РЕМЕНЬ",name: "ЙОГА АЙЕНГАРА",         sub: "Точность и выравнивание тела" },
  { label: "ЦВЕТОК",       name: "ЙОГА ДЛЯ БЕРЕМЕННЫХ",  sub: "Бережная поддержка на каждом этапе" },
  { label: "ПОЗВОНОЧНИК",  name: "ЗДОРОВАЯ СПИНА",        sub: "Метод Айенгара — йога с опорами" },
];
