...
const directions = [
  ...
  { img: "https://cdn.poehali.dev/files/e332e9bb-a6e5-4967-9dec-7382c12ad3fd.png", name: "ФИТНЕС МИКС",           sub: "Силовые + кардио · подходит женщинам и мужчинам · до 15 чел. (большой зал) / до 10 чел. (малый зал)" },
