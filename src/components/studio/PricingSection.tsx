...
const plans: Plan[] = [
  {
    title: "Абонемент · 60 мин",
    items: [
      { label: "4 занятия · 60 мин", price: "3 640 ₽", note: "срок действия 1 месяц" },
      { label: "8 занятий · 60 мин", price: "5 800 ₽", note: "срок действия 1 месяц" },
      { label: "13 занятий · 60 мин", price: "7 000 ₽", note: "срок действия 2 месяца" },
      { label: "16 занятий · 60 мин", price: "10 000 ₽", note: "срок действия 2 месяца" },
      { label: "26 занятий · 60 мин", price: "14 000 ₽", note: "срок действия 2 месяца" },
    ],
    footer: "На все абонементы действует платная заморозка",
  },
  {
    title: "Абонемент · 90 мин",
    items: [
      ...
      { label: "12 занятий · 90 мин", price: "10 300 ₽", note: "срок действия 2 месяца" },
      { label: "16 занятий · 90 мин", price: "12 800 ₽", note: "срок действия 2 месяца" },
      { label: "20 занятий · 90 мин", price: "15 400 ₽", note: "срок действия 2 месяца" },
    ],
    footer: "На все абонементы действует платная заморозка",
  },
  {
    ...
    items: [
      { label: "Занятие 60 мин", price: "1 200 ₽", note: "" },
      { label: "Занятие 90 мин", price: "1 500 ₽", note: "" },
      { label: "Семейная тренировка · 60 мин", price: "3 500 ₽", note: "" },
    ],
  },
  {
